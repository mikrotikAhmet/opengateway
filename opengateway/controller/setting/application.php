...
class ControllerSettingApplication extends Controller {
	...
	public function index() {
		$this->load->language('setting/application');
	...
	public function edit() {
		...
		if (($this->request->server['REQUEST_METHOD'] == 'POST') && $this->validateForm()) {
			...
			$this->response->redirect($this->url->link('setting/application', 'token=' . $this->session->data['token'] . '&application_id=' . $this->request->get['application_id'], 'SSL'));
		}
	...
	protected function getList() {
		...
		$data['insert'] = $this->url->link('setting/application/add', 'token=' . $this->session->data['token'], 'SSL');
		$data['delete'] = $this->url->link('setting/application/delete', 'token=' . $this->session->data['token'], 'SSL');
		...
		foreach ($results as $result) {
			$data['applications'][] = array(
				...
				'name'     => $result['name'],
				'url'      => $result['url'],
				'edit'     => $this->url->link('setting/application/edit', 'token=' . $this->session->data['token'] . '&application_id=' . $result['application_id'], 'SSL')
			);
		}
		...
		$this->response->setOutput($this->load->view('setting/application_list.tpl', $data));
	}

	public function getForm() {
		$data['heading_title'] = $this->language->get('heading_title');

		$data['text_form'] = !isset($this->request->get['application_id']) ? $this->language->get('text_add') : $this->language->get('text_edit');
		...
		if (!isset($this->request->get['application_id'])) {
			$data['action'] = $this->url->link('setting/application/add', 'token=' . $this->session->data['token'], 'SSL');
		} else {
			$data['action'] = $this->url->link('setting/application/edit', 'token=' . $this->session->data['token'] . '&application_id=' . $this->request->get['application_id'], 'SSL');
		}
		...
		if (isset($this->request->post['config_url'])) {
			...
			$data['config_url'] = $application_info['config_url'];
		} else {
			$data['config_url'] = '';
		}
		...
		if (isset($this->request->post['config_ssl'])) {
			...
			$data['config_ssl'] = $application_info['config_ssl'];
		} else {
			$data['config_ssl'] = '';
		}
		...
		if (isset($this->request->post['config_name'])) {
			...
			$data['config_name'] = $application_info['config_name'];
		} else {
			$data['config_name'] = '';
		}
		...
		if (isset($this->request->post['config_owner'])) {
			...
			$data['config_owner'] = $application_info['config_owner'];
		} else {
			$data['config_owner'] = '';
		}
		...
		if (isset($this->request->post['config_address'])) {
			...
			$data['config_address'] = $application_info['config_address'];
		} else {
			$data['config_address'] = '';
		}
		...
		} elseif (isset($application_info['config_geocode'])) {
			$data['config_geocode'] = $application_info['config_geocode'];
		} else {
			$data['config_geocode'] = '';
		}
		...
		if (isset($this->request->post['config_email'])) {
			...
			$data['config_email'] = $application_info['config_email'];
		} else {
			$data['config_email'] = '';
		}
		...
		if (isset($this->request->post['config_telephone'])) {
			...
			$data['config_telephone'] = $application_info['config_telephone'];
		} else {
		...
		if (isset($this->request->post['config_fax'])) {
			...
			$data['config_fax'] = $application_info['config_fax'];
		} else {
			$data['config_fax'] = '';
		}
		...
		} elseif (isset($application_info['config_image'])) {
			$data['image'] = $application_info['config_image'];
		} else {
			$data['image'] = '';
		}
		...
		} elseif (isset($application_info['config_image']) && is_file(DIR_IMAGE . $application_info['config_image'])) {
			$data['thumb'] = $this->model_tool_image->resize($application_info['config_image'], 100, 100);
		} else {
		...
		} elseif (isset($application_info['config_open'])) {
			$data['open'] = $application_info['open'];
		} else {
			$data['open'] = '';
		}
		...
		} elseif (isset($application_info['config_comment'])) {
			$data['comment'] = $application_info['comment'];
		} else {
			$data['comment'] = '';
		}
		...
		} elseif (isset($application_info['config_meta_title'])) {
			$data['config_meta_title'] = $application_info['config_meta_title'];
		} else {
		...
		if (isset($this->request->post['config_meta_description'])) {
			...
			$data['config_meta_description'] = $application_info['config_meta_description'];
		} else {
		...
		} elseif (isset($application_info['config_meta_keyword'])) {
			$data['config_meta_keyword'] = $application_info['config_meta_keyword'];
		} else {
		...
		if (isset($this->request->post['config_layout_id'])) {
			...
			$data['config_layout_id'] = $application_info['config_layout_id'];
		} else {
		...
		if (isset($this->request->post['config_template'])) {
			...
			$data['config_template'] = $application_info['config_template'];
		} else {
		...
		if (isset($this->request->post['config_country_id'])) {
			...
			$data['config_country_id'] = $application_info['config_country_id'];
		} else {
		...
		if (isset($this->request->post['config_zone_id'])) {
			...
			$data['config_zone_id'] = $application_info['config_zone_id'];
		} else {
		...
		if (isset($this->request->post['config_language'])) {
			...
			$data['config_language'] = $application_info['config_language'];
		} else {
		...
		if (isset($this->request->post['config_currency'])) {
			...
			$data['config_currency'] = $application_info['config_currency'];
		} else {
		...
		} elseif (isset($application_info['config_product_limit'])) {
			$data['config_product_limit'] = $application_info['config_product_limit'];
		} else {
		...
		} elseif (isset($application_info['config_product_description_length'])) {
			$data['config_product_description_length'] = $application_info['config_product_description_length'];
		} else {
		...
		} elseif (isset($application_info['config_tax'])) {
			$data['config_tax'] = $application_info['config_tax'];
		} else {
			$data['config_tax'] = '';
		}
		...
		} elseif (isset($application_info['config_tax_default'])) {
			$data['config_tax_default'] = $application_info['config_tax_default'];
		} else {
		...
		if (isset($this->request->post['config_account_id'])) {
			...
			$data['config_account_id'] = $application_info['config_account_id'];
		} else {
		...
		} elseif (isset($application_info['config_cart_weight'])) {
			$data['config_cart_weight'] = $application_info['config_cart_weight'];
		} else {
		...
		} elseif (isset($application_info['config_checkout_guest'])) {
			$data['config_checkout_guest'] = $application_info['config_checkout_guest'];
		} else {
		...
		} elseif (isset($application_info['config_checkout_id'])) {
			$data['config_checkout_id'] = $application_info['config_checkout_id'];
		} else {
		...
		} elseif (isset($application_info['config_order_status_id'])) {
			$data['config_order_status_id'] = $application_info['config_order_status_id'];
		} else {
		...
		} elseif (isset($application_info['config_stock_display'])) {
			$data['config_stock_display'] = $application_info['config_stock_display'];
		} else {
		...
		} elseif (isset($application_info['config_stock_checkout'])) {
			$data['config_stock_checkout'] = $application_info['config_stock_checkout'];
		} else {
		...
		if (isset($this->request->post['config_logo'])) {
			...
			$data['config_logo'] = $application_info['config_logo'];
		} else {
			$data['config_logo'] = '';
		}
		...
		} elseif (isset($application_info['config_logo']) && is_file(DIR_IMAGE . $application_info['config_logo'])) {
			$data['logo'] = $this->model_tool_image->resize($application_info['config_logo'], 100, 100);
		} else {
		...
		if (isset($this->request->post['config_icon'])) {
			...
			$data['config_icon'] = $application_info['config_icon'];
		} else {
			$data['config_icon'] = '';
		}
		...
		} elseif (isset($application_info['config_icon']) && is_file(DIR_IMAGE . $application_info['config_icon'])) {
			$data['icon'] = $this->model_tool_image->resize($application_info['config_icon'], 100, 100);
		} else {
		...
		} elseif (isset($application_info['config_image_category_height'])) {
			$data['config_image_category_height'] = $application_info['config_image_category_height'];
		} else {
		...
		} elseif (isset($application_info['config_image_thumb_width'])) {
			$data['config_image_thumb_width'] = $application_info['config_image_thumb_width'];
		} else {
		...
		} elseif (isset($application_info['config_image_thumb_height'])) {
			$data['config_image_thumb_height'] = $application_info['config_image_thumb_height'];
		} else {
		...
		} elseif (isset($application_info['config_image_popup_width'])) {
			$data['config_image_popup_width'] = $application_info['config_image_popup_width'];
		} else {
		...
		} elseif (isset($application_info['config_image_popup_height'])) {
			$data['config_image_popup_height'] = $application_info['config_image_popup_height'];
		} else {
		...
		} elseif (isset($application_info['config_image_product_width'])) {
			$data['config_image_product_width'] = $application_info['config_image_product_width'];
		} else {
		...
		} elseif (isset($application_info['config_image_product_height'])) {
			$data['config_image_product_height'] = $application_info['config_image_product_height'];
		} else {
		...
		} elseif (isset($application_info['config_image_category_width'])) {
			$data['config_image_category_width'] = $application_info['config_image_category_width'];
		} else {
		...
		} elseif (isset($application_info['config_image_additional_width'])) {
			$data['config_image_additional_width'] = $application_info['config_image_additional_width'];
		} else {
		...
		} elseif (isset($application_info['config_image_additional_height'])) {
			$data['config_image_additional_height'] = $application_info['config_image_additional_height'];
		} else {
		...
		} elseif (isset($application_info['config_image_related_width'])) {
			$data['config_image_related_width'] = $application_info['config_image_related_width'];
		} else {
		...
		} elseif (isset($application_info['config_image_related_height'])) {
			$data['config_image_related_height'] = $application_info['config_image_related_height'];
		} else {
		...
		} elseif (isset($application_info['config_image_compare_width'])) {
			$data['config_image_compare_width'] = $application_info['config_image_compare_width'];
		} else {
		...
		} elseif (isset($application_info['config_image_compare_height'])) {
			$data['config_image_compare_height'] = $application_info['config_image_compare_height'];
		} else {
		...
		} elseif (isset($application_info['config_image_wishlist_width'])) {
			$data['config_image_wishlist_width'] = $application_info['config_image_wishlist_width'];
		} else {
		...
		} elseif (isset($application_info['config_image_wishlist_height'])) {
			$data['config_image_wishlist_height'] = $application_info['config_image_wishlist_height'];
		} else {
		...
		} elseif (isset($application_info['config_image_cart_width'])) {
			$data['config_image_cart_width'] = $application_info['config_image_cart_width'];
		} else {
		...
		} elseif (isset($application_info['config_image_cart_height'])) {
			$data['config_image_cart_height'] = $application_info['config_image_cart_height'];
		} else {
		...
		} elseif (isset($application_info['config_image_location_width'])) {
			$data['config_image_location_width'] = $application_info['config_image_location_width'];
		} else {
		...
		} elseif (isset($application_info['config_image_location_height'])) {
			$data['config_image_location_height'] = $application_info['config_image_location_height'];
		} else {
		...
		if (isset($this->request->post['config_secure'])) {
			...
			$data['config_secure'] = $application_info['config_secure'];
		} else {
			$data['config_secure'] = '';
		}
		...
		$this->response->setOutput($this->load->view('setting/application_form.tpl', $data));
	}
	...
	protected function validateDelete() {
		...
		foreach ($this->request->post['selected'] as $application_id) {
			...
			$application_total = $this->model_sale_order->getTotalOrdersByApplicationId($application_id);
