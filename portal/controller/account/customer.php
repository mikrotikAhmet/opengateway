...
class ControllerAccountCustomer extends Controller {
	...
	public function add() {
		...
		if (($this->request->server['REQUEST_METHOD'] == 'POST') && $this->validateForm()) {
			...
			$url = "http://".API_BASE."/v1/account/addCustomer";
...
<request>
    ...
    public function edit() {
        ...
        if (($this->request->server['REQUEST_METHOD'] == 'POST') && $this->validateForm()) {
            ...
            $url = "http://".API_BASE."/v1/account/updateCustomer";
...
<request>
    ...
    protected function getList() {
        ...
        $url = "http://".API_BASE."/v1/account/getCustomers";
...
<request>
    ...
    protected function getForm(){
        ...
        if (isset($this->request->get['customer_id']) && ($this->request->server['REQUEST_METHOD'] != 'POST')) {
            ...
            $url = "http://".API_BASE."/v1/account/getCustomer";
