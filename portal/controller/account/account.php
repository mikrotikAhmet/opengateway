...
class ControllerAccountAccount extends Controller {
    ...
    public function addCard(){
        ...
        $url = "http://api.semitepayment.com/v1/account/addCard";
...
<request>
	...
	public function cardVerification(){
		...
		$url = "http://api.semitepayment.com/v1/gateway/Verification";
...
<request>
	...
	public function doVerification(){
		...
		if ($this->request->post['code'].'-'.$get_trx_id[1] != $this->encryption->decrypt($card_info['token'])){
			...
			$url = "http://api.semitepayment.com/v1/gateway/Capture";
...
<request>
	...
	public function sendMoney(){
		...
		if (!$account_info) {
			...
			$url = "http://api.semitepayment.com/v1/gateway/Send";
