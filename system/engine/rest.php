 ...
 * @version    rest.php 10/22/14 ahmet $
...
class REST {
	...
	private function get_status_message() {
		...
		$api_responses = $this->db->query("SELECT * FROM ".DB_PREFIX."api_response");

		foreach ($api_responses->rows as $api_response){
			$status[$api_response['code']] = $api_response['description'];
		}
