...
class Payvision_BasicOperations_Payment extends Payvision_Operation
{
	...
	public function setCardHolderInformation ($card_holder_data)
	{
		$this->addData('CardholderEmail', $card_holder_data['CardholderEmail']);
		$this->addData('CardholderIp',     $card_holder_data['CardholderIp']);
		$this->addData('CardholderUserAgent',     $card_holder_data['CardholderUserAgent']);
		$this->addData('CardholderClientIdentification',     $card_holder_data['CardholderClientIdentification']);
		$this->addData('MerchantUrl',     $card_holder_data['MerchantUrl']);
	}
