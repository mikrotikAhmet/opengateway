...
// Configuration
if (file_exists ($_SERVER['DOCUMENT_ROOT']. DIRECTORY_SEPARATOR . 'system/config/client.php')){
    require_once ($_SERVER['DOCUMENT_ROOT']. DIRECTORY_SEPARATOR .'system/config/client.php');
} else {
